...
-   Henter data ut fra modellen heights, som er datasett fra rstudio sin
    pakke modelr
...
ggplot(data, aes(x = income, fill = sex)) +
  ...
  scale_color_manual(values = c("male" = "#0055CC", "female" = "#CC0000")) +
  scale_fill_manual(values = c("male" = "#0055CC", "female" = "#CC0000")) +
  geom_vline(
    data = means_income,
...
ggplot(df, aes(x = afqt, y = income)) +
  geom_point(aes(color = sex), alpha = 0.4, size = 1.2) +
  geom_smooth(
    aes(group = sex),
    method = "lm", se = FALSE,
    size = 3, colour = "white"
  ...
  scale_color_manual(values = c(male = "#0055CC", female = "#CC0000"), name = "Kjonn") +
  scale_x_continuous(limits = c(0, 100), breaks = seq(0, 100, 10)) +
  scale_y_continuous(labels = label_number(big.mark = " ", decimal.mark = ",")) +
  labs(title = "Sammenheng mellom AFQT, inntekt og kjonn",
       x = "AFQT-score", y = "Inntekt") +
...
-   Sammenhengen mellom inntekt og evnenivå virket å ha en positiv
    korrelasjon

-   Økt kognitiv evne fører til økt inntekt

-   Forskning sier økt avkastning for kvinner, men menn ligger over i
    gjennomsnitt

-   Andre faktorer i spill
